...
<template>
  <Popover class="relative h-full">
    <Float auto-placement :offset="8" enter="transition duration-200 ease-out" enter-from="translate-y-1 opacity-0" enter-to="translate-y-0 opacity-100" leave="transition duration-150 ease-in" leave-from="translate-y-0 opacity-100" leave-to="translate-y-1 opacity-0">
      ...
      <PopoverPanel class="z-10 w-[20rem] max-w-[calc(100vw-2rem)] rounded-lg border border-gray-200 bg-white">
