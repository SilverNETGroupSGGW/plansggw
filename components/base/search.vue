    ...
    <Combobox v-model="modelValue">
      ...
      <div class="relative h-full">
        ...
        <TransitionRoot leave="transition ease-in duration-100" leave-from="opacity-100" leave-to="opacity-0" @after-leave="query = ''">
          ...
          <ComboboxOptions v-else class="absolute z-10 mt-4 max-h-60 w-full overflow-auto rounded-lg border border-gray-200 bg-white px-1 py-2 text-base shadow-lg focus:outline-none">
